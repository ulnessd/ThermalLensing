...
def process_video_to_heatmap(video_path):
    ...
    rows_data = heatmap_data[305:316, :]  # Slices rows 305 to 315 (Python slicing excludes the upper bound)
...
output_csv = os.path.join(directory, "KineticsLaserPosition.csv")
